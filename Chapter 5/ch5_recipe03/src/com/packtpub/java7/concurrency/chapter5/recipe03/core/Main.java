...
public class Main {
	...
	*/
	public static void main(String[] args) {
		...
		FolderProcessor system=new FolderProcessor("/Users/buyi/temp", "log");
		FolderProcessor apps=new FolderProcessor("~/myserver","log");
		FolderProcessor documents=new FolderProcessor("~/ruby","log");
